...
- delegate to `unity-dots-specialist` (the child reads `roles/unity-dots-specialist.md` itself) — Entity Component System, Jobs, Burst compiler
- delegate to `unity-shader-specialist` (the child reads `roles/unity-shader-specialist.md` itself) — Shader Graph, VFX Graph, URP/HDRP customization
- delegate to `unity-addressables-specialist` (the child reads `roles/unity-addressables-specialist.md` itself) — Addressable groups, async loading, memory
- delegate to `unity-ui-specialist` (the child reads `roles/unity-ui-specialist.md` itself) — UI Toolkit, UGUI, data binding, cross-platform input
