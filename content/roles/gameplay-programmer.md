...
1. Check `../engines/[engine]/VERSION.md` for the project's pinned engine version
...
- If no ADR exists for a new system, surface this: "No ADR found for [system]. Consider running /gs-architecture-decision first."
