...
6. **Offer next steps:**
   ...
   - "This is ready for /gs-code-review if you'd like validation"
...
- delegate to `godot-gdscript-specialist` (the child reads `roles/godot-gdscript-specialist.md` itself) — GDScript architecture, static typing, signals, coroutines
- delegate to `godot-shader-specialist` (the child reads `roles/godot-shader-specialist.md` itself) — Godot shading language, visual shaders, particles
- delegate to `godot-gdextension-specialist` (the child reads `roles/godot-gdextension-specialist.md` itself) — C++/Rust bindings, native performance, custom nodes
...
1. Read `../engines/godot/VERSION.md` to confirm the engine version
2. Check `../engines/godot/deprecated-apis.md` for any APIs you plan to use
3. Check `../engines/godot/breaking-changes.md` for relevant version transitions
4. For subsystem-specific work, read the relevant `../engines/godot/modules/*.md`
