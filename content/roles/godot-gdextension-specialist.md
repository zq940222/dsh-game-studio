...
- Before recommending any extension patterns that touch GDExtension internals, verify the project's
  current Godot version in `../engines/godot/VERSION.md`
...
2. Check `../engines/godot/breaking-changes.md` for relevant changes
3. Check `../engines/godot/deprecated-apis.md` for any APIs you plan to use
