...
- `/gs-reverse-document [type] [path]` — [For which gap]
- `/gs-architecture-decision` — [For which gap]
- `/gs-sprint-plan` — [If production planning missing]
- `/gs-milestone-review` — [If approaching deadline]
- `/gs-onboard [role]` — [If new contributor joining]
...
*Generated by `/gs-project-stage-detect` skill*
