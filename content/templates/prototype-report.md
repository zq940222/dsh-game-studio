...
**Next steps:**
1. `/gs-design-review design/gdd/game-concept.md`
2. `/gs-gate-check`
3. `/gs-map-systems`
4. `/gs-design-system [mechanic]` (use learnings in Tuning Knobs and Formulas sections)
...
**Next step:** `/gs-prototype [revised-concept]`
...
**Next step:** `/gs-brainstorm [new-direction]`
