...
- Run `/gs-balance-check` on [specific aspect]
...
- [ ] **Balance pass**: Run `/gs-balance-check` on progression curve
...
**Related Skills**:
- `/gs-balance-check` — Validate formulas and progression
- `/gs-architecture-decision` — Document technical decisions
- `/gs-code-review` — Ensure code matches clarified design

---

*This document was generated by `/gs-reverse-document design [path]`*
