...
Critical paths to verify before QA hand-off (run via `/gs-smoke-check`):
...
*Results and sign-off are tracked in the QA sign-off report generated by `/gs-team-qa` — not in this plan file.*

*Template: `../templates/test-plan.md`*
*Generated by: `/gs-qa-plan` — do not edit this line*
