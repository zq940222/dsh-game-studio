...
<!-- Living document — updated by /gs-architecture-review after each review run.
...
| TR-[gdd]-002 | [filename] | [system name] | [one-line summary] | — | ❌ GAP | Needs `/gs-architecture-decision [title]` |
...
**When running `/gs-architecture-review`**: The skill will update this document
