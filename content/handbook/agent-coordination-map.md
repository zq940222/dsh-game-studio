...
```
1. qa-tester          -- Files bug report with /gs-bug-report
...
```
1. producer           -- Plans sprint with /gs-sprint-plan new
...
```
1. producer           -- Runs /gs-milestone-review
...
2. release-manager      -- Cuts release branch, generates /gs-release-checklist
...
7. release-manager      -- Generates /gs-changelog, tags release, creates release notes
...
2. prototyper           -- Scaffolds concept prototype with /gs-prototype
...
2. prototyper           -- Builds production-quality end-to-end build with /gs-vertical-slice
