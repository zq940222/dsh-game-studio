...
**Format**: `/gs-reverse-document <type> <path>`
...
**Examples**:
```bash
/gs-reverse-document design src/gameplay/magic-system
/gs-reverse-document architecture src/core/entity-component
/gs-reverse-document concept prototypes/vehicle-combat
```
...
1. Run /gs-balance-check on combat formulas (exponential scaling concern)
...
```
User: /gs-reverse-document design src/gameplay/[system]
...
Agent: ✅ Written to design/gdd/[system-name].md
       ...
       - Run /gs-balance-check to validate [curve]
