...
**When to run:**
- Polish phase — before `/gs-gate-check release`
...
Read:
- `../../handbook/technical-preferences.md` — engine (for engine-specific memory
...
5. Run `/gs-bug-triage sprint` after the session to integrate any S1/S2 issues

If the verdict is FAIL, run `/gs-smoke-check` again after fixing the issues."
