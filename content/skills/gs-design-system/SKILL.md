...
Before finalizing the GDD, spawn `creative-director` via Task using gate **CD-GDD-ALIGN** (`../../handbook/director-gates.md`).
...
> open a fresh Claude Code session and run `/gs-design-system [system-name]` — it will
