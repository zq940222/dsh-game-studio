...
if it exists, use its value (explicit override from `/gs-gate-check`). Otherwise,
...
- **Missing design docs?** → `/gs-reverse-document design src/[system]`
